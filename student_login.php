...
<div class="wrapper">
    ...
    <div id="content">
        ...
        <h3 style="text-align: center;">Login as Student</h3>
        <hr style="margin-bottom: 0px; padding-bottom: 0px;">
        <div class="row" style="padding: 15px;">
            <form action="student_connect_login.php" style="width: 100%;" id="login_form" method="POST">
                <input type="hidden" name="_token" value="1R0xWh2R9gVW7WsyeShfkeJFIpRoZtjB4i5otCqU">
                ...
                <div class="" style="text-align:center">
                    <button type="submit" class="btn btn-success">Login</button>
                     <button type="submit" class="btn btn-success"><a href="student_registersrabon.php" style="color: white;">Register</a></button>
                </div>
            </form>
        </div>
    </div>
